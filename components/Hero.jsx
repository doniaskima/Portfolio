...
import UserImg from '../public/assets/images/icons/Donia.jpg';
				...
				<div className='ml-0 md:ml-16'>
					...
					<h1 className='text-2xl font-normal leading-10'>
						<span className='block'>
							...
							{', With a passion for staying up-to-date with industry trends and exploring new technologies'}
						</span>
						{
							'I am determined to become a skilled software engineer and make a meaningful impact in the tech world.'
						}
